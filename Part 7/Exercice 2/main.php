...
<body style="background-image: linear-gradient(120deg, #f6d365 0%, #fda085 100%)" ;>
    ...
    <main class="text-center justify-content-center">
        <div class="border d-inline-flex p-2 justify-content-center" style="background-image: linear-gradient(to top, #cfd9df 0%, #e2ebf0 100%);">

            <h2 class="text-center"><a href="index.php" >Page precedente</h2></a>

        </div></a>

        <!-- //PHP ========================================= -->
        <?php
        echo '<h1>'.'Bonjour '. ' ' . $lastname . ' ' . $firstname . ' '.  'tu as '. ' ' . $age . ' ' . 'ans'. '</h1>';
        ?>
        <!-- //============================================= -->
    </main>
    <footer>
